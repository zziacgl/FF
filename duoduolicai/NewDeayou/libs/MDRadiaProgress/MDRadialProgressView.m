...
//    NSLog(@"%f",width);
	...
	self.label = [[MDRadialProgressLabel alloc] initWithFrame:CGRectMake(width / 2, width / 2, width, width) andTheme:self.theme];
//    self.label.center = CGPointMake(width/2, width/2);
...
- (void)notifyProgressChange
{
    ...
    self.label.text = self.label.isShowPercent? [NSString stringWithFormat:@"%.0f%%", percentageCompleted]:[NSString stringWithFormat:@"%0.2f", self.progressCounter];
