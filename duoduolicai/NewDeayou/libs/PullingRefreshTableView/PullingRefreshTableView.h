...
typedef void(^LaunchRefreshingFinished) (void);
...
@property(nonatomic,retain)  LooadingView *headerView;
@property(nonatomic,retain)    LooadingView *footerView;
