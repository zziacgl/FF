...
- (void)updateUI {
    ...
    self.pathWidth = self.bounds.size.width / 1.10;
...
- (CAShapeLayer *)trackLayer {
    if (!_trackLayer) {
        ...
        [self loadLayer:_trackLayer WithColor:kCOLOR_R_G_B_A(239, 239, 239, 1)];
...
- (CAGradientLayer *)gradientLayer {
    if (!_gradientLayer) {
        ...
        _gradientLayer.backgroundColor = kCOLOR_R_G_B_A(253, 83, 83, 1).CGColor;
...
- (UILabel *)progressLabel {
    if (!_progressLabel) {
        ...
        _progressLabel.textColor = kCOLOR_R_G_B_A(253, 83, 83, 1);
