...
- (void)setUp
{
    waterWaveHeight = self.frame.size.height/2;
    waterWaveWidth  = self.frame.size.width;
    _firstWaveColor = [UIColor colorWithRed:247/255.0 green:194/255.0 blue:195/255.0 alpha:1];
    _secondWaveColor = [UIColor colorWithRed:248/255.0f green:139/255.0f blue:140/255.0f alpha:1];
