...
- (void)defaultInit {
    ...
    self.progress = 0;
    self.greyProgressColor = [UIColor clearColor];
    self.progressTintColor = kCOLOR_R_G_B_A(253, 83, 83, 1);
    self.designsMargin = 5.0;
    self.BarRedius = self.frame.size.width/2+8;
