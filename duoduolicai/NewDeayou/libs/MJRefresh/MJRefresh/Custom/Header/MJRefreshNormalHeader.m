...
- (void)placeSubviews
{
    ...
    // 箭头的中心点
    CGFloat arrowCenterX = self.stateLabel.center.x - self.arrowView.mj_w/2+70;
//    NSLog(@"%f",self.stateLabel.center.x);
//     NSLog(@"%f",self.stateLabel.mj_w/2);
//     NSLog(@"%f",self.arrowView.mj_w/2);
