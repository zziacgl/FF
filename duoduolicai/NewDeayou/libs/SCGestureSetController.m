...
- (void)bottomButtonAction:(UIButton *)sender {
    ...
    [ud setValue:@"1" forKey:@"isShouShi"];
}
...
//        [ud setObject:@"0" forKey:@"verifyNumber"];
        return YES;
    } else {
        
//        NSString *n=[NSString stringWithFormat:@"%@",[ud objectForKey:@"verifyNumber"]];
//        int verifyNumber=[n intValue];
//        if (verifyNumber<6) {
//            verifyNumber++;
//            [ud setObject:[NSString stringWithFormat:@"%d",verifyNumber] forKey:@"verifyNumber"];
