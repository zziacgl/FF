...
@interface DYReahargeRecordsVC ()<UITableViewDataSource,UITableViewDelegate,PullingRefreshTableViewDelegate>
{
    UINib * nibContent;
    int page;
}
...
@implementation DYReahargeRecordsVC
...
- (void)viewDidLoad
{
    ...
    //设置下拉刷新tableView
    _tableView = [[PullingRefreshTableView alloc] initWithFrame:CGRectMake(0, 0, kScreenSize.width, kScreenSize.height-64) style:UITableViewStylePlain topTextColor:[UIColor blackColor] topBackgroundColor:nil bottomTextColor:[UIColor blackColor] bottomBackgroundColor:nil];
...
-(void)queryDataIsRefreshing:(BOOL)isRefreshing
{
    ...
    if(isRefreshing)
    {
        ...
        [diyouDic insertObject:@"get_recharge_list" forKey:@"q" atIndex:0];
...
//    lab.text=[dic DYObjectForKey:@"payment_name"];
