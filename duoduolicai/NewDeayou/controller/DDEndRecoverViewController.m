...
@interface DDEndRecoverViewController ()<UITableViewDataSource,UITableViewDelegate,PullingRefreshTableViewDelegate>
{
    UINib *nibcontent;
    BOOL isViewDidLoad;
    int page;
...
@implementation DDEndRecoverViewController
...
- (void)getallData:(BOOL)isRefreshing {
    if (isRefreshing)
    {
        ...
        [diyouDic1 insertObject:@"end" forKey:@"status_type" atIndex:0];
