...
- (void)drawView {
    if (!_paymentAlert) {
        ...
        _inputView = [[UIView alloc]initWithFrame:CGRectMake(15, _paymentAlert.frame.size.height-(PAYMENT_WIDTH-30)/6-55, PAYMENT_WIDTH-30, (PAYMENT_WIDTH-30)/6)];
        ...
        self.forgetBtn.frame = CGRectMake(15, CGRectGetMaxY(_inputView.frame) + 5,  PAYMENT_WIDTH-30, 20);
        ...
        self.forgetBtn.titleLabel.textAlignment = NSTextAlignmentRight;
        [self.forgetBtn setContentHorizontalAlignment:UIControlContentHorizontalAlignmentRight];
        [_paymentAlert addSubview:self.forgetBtn];
